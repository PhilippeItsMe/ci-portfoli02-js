...
let q6 = ["Question 6/6 : What musical genre is Yngwie Malmsteen credited with ?", "Neo Metal", "Blues", "Rock", "Neo Metal", "q7"];
let q7 = ["You know now if you fully lived the 80' and if you are a rock dude!", "Start again", "Start again", "Start again", "Start again", "q7"];
